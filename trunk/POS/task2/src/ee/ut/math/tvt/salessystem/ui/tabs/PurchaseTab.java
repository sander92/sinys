...
//		domainController.cancelCurrentPurchase();
	...
	public void endPurchaseAfterPaying() {
		...
		Sale sale = new Sale(model.getCurrentPurchaseTableModel()
				.getTableRows());
	...
	public void refresh() {
		model.getWarehouseTableModel().populateWithData(domainController.getAllStockItems());
		model.getWarehouseTableModel().fireTableDataChanged();
		((DefaultComboBoxModel<StockItem>) purchasePane.getStockItemSelector().getModel())
				.removeAllElements();
