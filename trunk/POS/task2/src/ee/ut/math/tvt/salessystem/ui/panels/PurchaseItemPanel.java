...
public class PurchaseItemPanel extends JPanel {
	...
	public void reset() {
		...
		((DefaultComboBoxModel<StockItem>) stockItemSelector.getModel())
				.removeAllElements();
	...
	public JComboBox<StockItem> getStockItemSelector() {
		return stockItemSelector;
	}

	public void setStockItemSelector(JComboBox<StockItem> stockItemSelector) {
		this.stockItemSelector = stockItemSelector;
	}
